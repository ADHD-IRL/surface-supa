...
import { ArrowRight, Clock, AlertTriangle, CheckCircle2, Loader2 } from 'lucide-react';
        ...
        {sessions.map((session) => {
          ...
          return (
            <Link key={session.id} to={`/sessions/${session.id}`}>
              <Card className="p-4 bg-card border border-border hover:border-primary/30 transition-colors cursor-pointer group">
